...
public class SemaPhoreDemo05 {
   ...
   public static class T extends Thread{
       ...
       public void run() {
           ...
           try {
               //semaphore.acquire();
               System.out.println(System.currentTimeMillis()+","+thread.getName()+"----------尝试获取许可!,当前剩余可申请量："+semaphore.availablePermits());
               ...
               if (acquireSuccess){
                   ...
                   System.out.println(System.currentTimeMillis()+","+thread.getName()+"获取许可失败!");
